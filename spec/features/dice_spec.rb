...
describe "/dice/[RANDOM_DICE]/[RANDOM_SIDES]" do
  it "has a level one heading with the text '[RANDOM_DICE]d[RANDOM_SIDES]'", points: 5 do
...
describe "/dice/[RANDOM_DICE]/[RANDOM_SIDES]" do
  it "displays the outcome of rolling [RANDOM_DICE] [RANDOM_SIDES]-sided dice in li's of an unordered list", points: 5 do
